...
#         print(img_features.size())
        ...
        alphas = torch.zeros(batch_size, max_timespan, 49, self.decoder_dim).cuda()
...
#                 print(side_embeds.size())
            ...
            context, alpha = self.attention(img_features, enc)
...
#         print(word_map.keys())
        ...
        alphas = torch.ones(beam_size, 1, img_features.size(1), self.decoder_dim).cuda()
