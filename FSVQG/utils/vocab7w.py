...
#             words.extend(answer)
    ...
    counter = Counter()
    for i, (qid, entry) in enumerate(dataset.items()):
    ...
    ans_words = list(set(words))
    print(len(words))
    ans_vocab = create_vocab(ans_words)
    ans_vocab.save("vocab_7w_ans.json")
#     with open("vocab_7w_ans.json", 'w') as fid:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--questions', type=str,
                        default='qid2data_7w.json',
                        help='Path for train questions file.')
#     parser.add_argument('--cat2qid', type=str,
#                         default='../visual7w.json',
#                         help='Path for the question types.')
    ...
    parser.add_argument('--vocab-path', type=str,
                        default='data/processed/vocab_7w_new.json',
