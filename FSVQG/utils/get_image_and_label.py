...
#     encoder.cuda()
    ...
    d_img_ids = h5file.create_dataset(
        "qid2img", (total_questions,), dtype='i')
...
#     h5file.create_dataset("image_ids", data=np.array(image_ids), dtype="i")
    h5file.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str,
                        default='data/processed/img_iq_dataset.hdf5',
                        help='directory for resized images.')
