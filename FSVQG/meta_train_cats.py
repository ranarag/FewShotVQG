...
def fast_adapt(train_batch, test_batch, learner, alpha_c, loss_fn, args, adaptation_steps, word_dict, nlge):
    ...
    # print(preds)
    valid_error= calc_loss_and_acc(loss_fn, alpha_c, preds, args, alphas, eval_targets)
        ...
        if args.mode == 'Train':
            ...
            if epoch % 10 == 0:
                torch.save(vqg_net.state_dict(),
                            ...
                            'epoch{}_{}_{}_{}_{}_new{}shot_cat.pkl'.format(epoch, args.network, args.metalr_type, args.dataset_type, \
