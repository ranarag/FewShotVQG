...
#     print(summary(learner.module, (img_train, cat_train, ans_train, alen_train, cap_train)))
    ...
    preds, alphas = learner(img_test, cat_test, ans_test, alen_test, cap_test)
    # print(preds)
        ...
        if args.mode == 'Train':
            ...
            if epoch % 10 == 0: 
                torch.save(vqg_net.state_dict(),
                            ...
                            'epoch{}_{}_{}_{}_new{}shot_ans_cats.pkl'.format(epoch, args.network, args.dataset_type, lm_encoder, args.train_query)))
...
def meta_test(lm_encoder, nlge, maml, cross_entropy_loss, valset, word_dict, ans_dict, args, log_interval):
    ...
    for epoch in range(1,11):
        ...
        for idx,(imgs, captions, answer, cat, qids, img_ids) in enumerate(tqdm_gen):
            ...
            learner.train()
            optimizer = optim.Adam(learner.parameters(), 0.002)
...
#                     print(ans_test[0])
            ...
            tqdm_gen.set_description('RUN {},'
                                     ...
                                     ' CIDEr={:.4f}'.format(epoch, 
                                                           ...
                                                           cider.avg))
        with open('{}_{}_{}_ans_cat_res{}shot/preds_gts_dict_run{}.json'.format(model_name, args.dataset_type, lm_encoder, N, epoch), 'w') as fid:
